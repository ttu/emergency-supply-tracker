...
describe('recommendedQuantity mutation killers', () => {
  describe('children * CHILDREN_REQUIREMENT_MULTIPLIER (not division)', () => {
  ...
  describe('peopleMultiplier multiplication in calculateRecommendedQuantity', () => {
  ...
  describe('pets * PET_REQUIREMENT_MULTIPLIER (not division)', () => {
