...
describe('preparedness mutation killers', () => {
  ...
  // =========================================================================
  describe('empty categoryStatuses guard', () => {
  ...
  // =========================================================================
  describe('empty recommendedForHousehold guard', () => {
  ...
  // =========================================================================
  describe('totalPeople = adults + children (not minus)', () => {
  ...
  // =========================================================================
  describe('maxPossibleScore === 0 guard', () => {
  ...
  // =========================================================================
  describe('items.filter for category filtering', () => {
  ...
  // be lost.
  // =========================================================================
  describe('options object passed to calculateCategoryPercentage', () => {
...
// ============================================================================
// Merged from preparedness.behaviors2.test.ts
// ============================================================================
...
// ============================================================================
describe('calculatePreparednessScoreFromCategoryStatuses edge cases', () => {
...
// Mutant: block body removed {} or condition replaced with false
// ============================================================================
describe('calculatePreparednessScore empty recommendations', () => {
...
// ============================================================================
describe('calculateCategoryPreparedness filters by category', () => {
