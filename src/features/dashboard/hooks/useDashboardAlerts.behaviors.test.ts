...
describe('useDashboardAlerts behaviors', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    defaultMocks();
  });

  describe('backupReminderDismissed conditional', () => {
  ...
  describe('storage alert object literal', () => {
  ...
  describe('showNotification string literal', () => {
  ...
  describe('setBackupReminderDismissed in dismissAll', () => {
  ...
  describe('NOTIFICATION_IDS.has in dismissAll', () => {
  ...
  describe('inventoryAlertIds.length > 0 check', () => {
  ...
  describe('useMemo dependency array for allAlerts', () => {
  ...
  describe('useMemo dependency array for dismissedSet', () => {
  ...
  describe('useMemo dependency array for hiddenAlertsCount', () => {
  ...
  describe('useMemo dependency array for handleDismissAlert', () => {
  ...
  describe('useMemo dependency array for handleDismissAllAlerts', () => {
