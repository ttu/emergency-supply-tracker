...
- Test timeout is set to 60 seconds (1 minute) per test in playwright.config.ts, with individual tests overriding this with `test.setTimeout(120000)` (2 minutes) for comprehensive flows
